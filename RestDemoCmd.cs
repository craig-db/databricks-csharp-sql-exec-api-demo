...
namespace RestDemo
{
    ...
    class RestDemo
    {
        ...
        static async Task RunAsync()
        {
            ...
            string sql = "select Year, Month, DayofMonth, DepTime, ArrTime, FlightNum, AirTime, ArrDelay, DepDelay from field_demos.airlinedata.flights limit 10";
            ...
            SqlResponse r = await GetSqlResponse(s);
        ...
        static async Task<SqlResponse> GetSqlResponse(SqlRequest statement) {
        ...
        static async Task<SqlResponse> GetSqlChunk(SqlRequest statement) {
            HttpResponseMessage response = await client.PostAsJsonAsync("/api/2.0/sql/statements/", statement);
            response.EnsureSuccessStatusCode();
            SqlResponse r = await response.Content.ReadAsAsync<SqlResponse>();
            return r;
